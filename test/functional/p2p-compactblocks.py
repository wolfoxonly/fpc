...
# TestNode: A peer we use to send messages to Flashpaychaind, and store responses.
...
class CompactBlocksTest(FlashpaychainTestFramework):
    ...
    # This test actually causes Flashpaychaind to (reasonably!) disconnect us, so do this last.
    ...
    # Flashpaychaind's choice of nonce.
    ...
    # Test that Flashpaychaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for Flashpaychaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # Flashpaychaind will not send blocktxn responses for blocks whose height is
