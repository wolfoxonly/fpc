...
By default, Flashpaychaind will dump mempool on shutdown and
...
class MempoolPersistTest(FlashpaychainTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give Flashpaychaind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent Flashpaychaind from writing mempool.dat to disk. Verify that `savemempool` fails")
