...
class BIP66Test(FlashpaychainTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # Flashpaychaind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and Flashpaychaind produces more specific reject
            # reasons.
