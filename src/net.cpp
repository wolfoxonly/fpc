...
// Copyright (c) 2009-2012 The Flashpaychain Core developers
...
static const int MAX_OUTBOUND_CONNECTIONS = 32;//<zxb>ljn
...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Flashpaychain-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Flashpaychain " + FormatFullVersion();
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Flashpaychain is probably already running."), addrBind.ToString().c_str());
        else
...
{
    printf("StopNode()\n");
    GenerateFlashpaychains(false, NULL);
    MapPort(false);
