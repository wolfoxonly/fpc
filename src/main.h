...
static const uint256 hashGenesisBlockOfficial("0x000000d611bf7afe3b267e0289123471aca98042004d997f3035e024499ce61a");//fpc
...
#ifdef TESTING
void FlashpaychainMiner(CWallet *pwallet, bool fProofOfStake, bool fGenerateSingleBlock = false);
#else
...
public:
    ...
    */
    ...
    /** Amount of Flashpaychains spent by this transaction.
    ...
    /** Amount of Flashpaychains coming in to this transaction
...
public:
    ...
    /**
     * Duplicate from Flashpaychainrpc that originaly define this method.
