    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new FlashpaychainUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->FlashpaychainAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Flashpaychain."), QMessageBox::Ok);
