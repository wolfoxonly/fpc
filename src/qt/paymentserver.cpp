...
const QString BITCOIN_IPC_PREFIX("Flashpaychain:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Flashpaychain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Flashpaychain: click-to-pay handler");
    else
...
{
    // clicking on Flashpaychain: URLs creates FileOpen events on the Mac:
