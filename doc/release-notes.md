...
Flashpaychain Core version *version* is now available from:

  <https://Flashpaychain.org/bin/Flashpaychain-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Flashpaychain Core is now 4.8. No effort will be
