...
This document provides guidelines for internationalization of the Flashpaychain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `Flashpaychain_en.ts` remains unchanged.
