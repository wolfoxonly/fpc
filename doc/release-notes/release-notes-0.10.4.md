Flashpaychain Core version 0.10.4 is now available from:

  <https://Flashpaychain.org/bin/Flashpaychain-core-0.10.4/>
...
- #6953 `43c2789` Split Flashpaychain-tx into its own package
- #6953 `dfe0d4d` Include Flashpaychain-tx binary on Debian/Ubuntu
