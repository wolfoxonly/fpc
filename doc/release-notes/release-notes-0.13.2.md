Flashpaychain Core version 0.13.2 is now available from:

  <https://Flashpaychain.org/bin/Flashpaychain-core-0.13.2/>
...
- #8908 `4a974b2` Update Flashpaychain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow Flashpaychain-tx to create v2 transactions (btcdrak)
