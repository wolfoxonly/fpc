Flashpaychain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/Flashpaychain/files/Flashpaychain/Flashpaychain-0.5.4/
...
http://gitorious.org/Flashpaychain/Flashpaychaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Flashpaychain-Qt notifications under Growl 1.3.
Increase required age of Flashpaychain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFlashpaychain properly when installing Flashpaychain-Qt over it. (Windows)
