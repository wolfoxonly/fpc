Flashpaychain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/Flashpaychain/files/Flashpaychain/Flashpaychain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Flashpaychain
...
New/changed settings (command-line or Flashpaychain.conf file)
--------------------------------------------------------
